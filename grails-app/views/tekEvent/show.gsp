...
<%@ page import="tekdaystwo.TekEvent" %>
<!doctype html>
<html>
	<head>
			...
			<ol class="property-list tekEvent">
				...
				<li class="fieldcontain">
					<span id="city-label" class="property-label"><g:message code="tekEvent.city.label" default="Location" /></span>
						...
						<span class="property-value" aria-labelledby="city-label"><g:fieldValue bean="${tekEventInstance}" field="city"/>  in  <g:fieldValue bean="${tekEventInstance}" field="venue"/></span>
				...
				<li class="fieldcontain">
					<span id="startDate-label" class="property-label"><g:message code="tekEvent.startDate.label" default="Start Date" /></span>
						...
						<span class="property-value" aria-labelledby="startDate-label"><g:formatDate format="dd.MM.yyyy" date="${tekEventInstance?.startDate}" /> from <g:formatDate format="HH:mm" date="${tekEventInstance?.startDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="endDate-label" class="property-label"><g:message code="tekEvent.endDate.label" default="End Date" /></span>
						...
						<span class="property-value" aria-labelledby="endDate-label"><g:formatDate format="dd.MM.yyyy" date="${tekEventInstance?.endDate}" /> to <g:formatDate format="HH:mm" date="${tekEventInstance?.endDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="messages-label" class="property-label"><g:message code="tekEvent.messages.label" default="Messages" /></span>
						...
						<span class="property-value" aria-labelledby="messages-label"><g:link controller="message" action="list" id="${tekEventInstance.id}">View Messages</g:link></span>
